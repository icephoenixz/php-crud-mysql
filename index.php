...
<body>
    <nav class="navbar navbar-expand-lg navbar-dark bg-danger bg-gradient">
        <div class="container">
            <a class="navbar-brand" href="./">PHP CRUD MYSQL</a>
            <div>
    ...
    <div class="container px-5 my-3">
        <h2 class="text-center">Crear, leer, actualizar y eliminar operaciones con PHP y MySQL</h2>
        <div class="row">
                    ...
                    <div class="card shadow rounded-0">
                        <div class="card-header">
                            <div class="d-flex justify-content-between align-items-center">
                                <div class="card-title col-auto flex-shrink-1 flex-grow-1"><b>PHP CRUD MYSQL</b></div>
                                <div class="col-auto">
                                    <button type="button" id="add_new" class="btn btn-sm btn-danger bg-gradient rounded-0"><i class="fa-solid fa-plus-square"></i> Agregar Nuevo</button>
                                </div>
                            </div>
                        </div>
